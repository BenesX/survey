        ...
        <div class="sv_container">
          ...
          <template v-if="survey.state === 'running'">
              <div :class="css.body">
                ...
                <div v-if="survey.isNavigationButtonsShowing" :class="css.footer">
                    <template v-if="!survey.isFirstPage && survey.isShowPrevButton">
                      <input type="button" 
                    ...
                    <template v-else>
                      <input type="button" 
                        :value="survey.pagePrevText"
                        :class="getNavBtnClasses('disabledPrev')"/>
                    </template>
                    <span :class="getNavBtnClasses('pageCount')">{{ survey.currentPageNo + 1 }}/{{ survey.PageCount }}</span>
